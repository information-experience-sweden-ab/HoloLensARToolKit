...
public class ARUWPControllerEditor : Editor {
    ...
    public override void OnInspectorGUI() {
        ...
        if (useCameraParamFile) {
            EditorGUILayout.HelpBox("The camera calibration file should match the video parameter for ARUWPVideo, otherwise the program will crash. The files are stored in StreamingAssets folder. Please consider calibrate your device for better accuracy (see HoloLensCamCalib project). ", MessageType.Info);
